...
public final class SiteMessagesProcessor extends LabelBundleProcessor {
    private final String template;
    private final String method_template;

    public SiteMessagesProcessor() {
        try {
            template = load("SiteMessages.template");
    ...
    protected String getTargetSimpleName(TypeElement typeElement) {
        return getSiteMessagesClassName(typeElement, false);
    }

    static final String getSiteMessagesClassName(TypeElement typeElement, boolean fqcn) {
        ...
        return (fqcn ? typeElement.getEnclosingElement().toString() + "." : "") + shortName + "SiteMessages";
    }
