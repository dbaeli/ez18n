...
La problématique de l'application multi écran
...
Demo StockWatcher
Idée 1 : des tests JUnit pour la validation orthographique
Idee 2 : un JSR pour les ResourceBundle 2.0
